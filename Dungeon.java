...
//        
        ...
        do {//startat loop
            ...
            if(monster != null) {
                System.out.println("Du hittar ett monster i rummet!");
                System.out.println("Ni börjar slåss!");
                var fighting = true;
                while (player.getHealthPoints() > 0 && fighting ){
                    System.out.println("Du attackerar monstret");
                    monster.setHealthPoints(monster.getHealthPoints() - player.getDamage());
                    if(monster.getHealthPoints() <= 0){
                        fighting = false;
                        System.out.println("Du dödade monstret");
                        continue;
                    }
                    System.out.println("Monstret har nu " + monster.getHealthPoints() + " liv");
                    System.out.println("Monstret attackerar dig");
